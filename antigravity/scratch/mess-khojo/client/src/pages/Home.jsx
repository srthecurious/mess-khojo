                                ...
                                >
                                    <div className="flex gap-2">
                                        ...
                                        <a href="https://chat.whatsapp.com/LYhQ5jOBMfZItlupwWbrwx" target="_blank" rel="noopener noreferrer" className="snap-start flex-shrink-0 w-[90%] md:w-[48%]">
                                            <div className="rounded-2xl bg-gradient-to-r from-[#25D366] to-[#128C7E] p-4 flex items-center gap-3">
                                                ...
                                                <div className="flex-grow min-w-0">
                                                    <h3 className="text-white font-bold text-sm leading-tight">Join Our WhatsApp Community</h3>
                                        ...
                                        <a href="https://t.me/messkhojo" target="_blank" rel="noopener noreferrer" className="snap-start flex-shrink-0 w-[90%] md:w-[48%]">
                                            <div className="rounded-2xl bg-[#0088cc] p-4 flex items-center gap-3">
                                                <div className="flex-shrink-0 w-10 h-10 bg-white rounded-full flex items-center justify-center">
                                                ...
                                                <div className="flex-grow min-w-0">
                                                    <h3 className="text-white font-bold text-sm leading-tight">Join Our Telegram Group</h3>
                                                    <p className="text-white/75 text-xs mt-0.5">Chat directly with students</p>
                                                </div>
