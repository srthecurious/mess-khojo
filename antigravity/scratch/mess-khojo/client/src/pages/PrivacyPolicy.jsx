            ...
            <div className="max-w-4xl mx-auto p-6 md:p-10">
                <div className="bg-white rounded-3xl shadow-sm border border-brand-light-gray p-8 md:p-12">
                    ...
                    <div className="prose prose-lg text-gray-600">
                        <p className="mb-4">Last updated January 02, 2026</p>

                        <p className="mb-4">
                            This Privacy Notice for MessKhojo (doing business as messkhojo.com) ('we', 'us', or 'our'), describes how and why we might access, collect, store, use, and/or share ('process') your personal information when you use our services ('Services'), including when you:
                        </p>
                        <ul className="list-disc pl-5 mb-4">
                            <li>Visit our website at https://messkhojo.com/ or any website of ours that links to this Privacy Notice</li>
                            <li>Use MessKhojo. MessKhojo operates an online platform designed to facilitate the discovery and booking of student accommodation, hostels, and PG (Paying Guest) residences. Our service allows users to search for and filter local accommodation based on their specific budget and comfort requirements. When a user chooses to book a room through our Website, we act as an intermediary. To ensure the completion of the booking and to enable a seamless check-in process, we share the user’s contact information with the respective property owner or manager. Conversely, we provide the user with the contact details of the owner to organise travel and arrival logistics. Our role is limited to connecting users with accommodation providers; we do not own, manage, or control the properties listed on the platform.</li>
                            <li>Engage with us in other related ways, including any marketing or events. We are not a party to any rental agreement, lease, or transaction entered into between users and property owners. Any agreements, payments, or disputes are strictly between the user and the respective property owner.</li>
                        </ul>

                        <p className="mb-4">
                            Questions or concerns? Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at messkhojooperator@gmail.com.
                        </p>

                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">SUMMARY OF KEY POINTS</h2>
                        ...
                        <p className="mb-2"><strong>Do we process any sensitive personal information?</strong> We do not intentionally collect or process sensitive personal information, such as racial or ethnic origin, religious beliefs, sexual orientation, health data, or biometric data.</p>
                        <p className="mb-2"><strong>Do we collect any information from third parties?</strong> We may collect information from public databases, marketing partners, social media platforms, and other outside sources.</p>
                        ...
                        <p className="mb-2"><strong>In what situations and with which types of parties do we share personal information?</strong> We may share information in specific situations and with specific categories of third parties.</p>
                        ...
                        <p className="mb-2"><strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by submitting a data subject access request, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.</p>
                        <p className="mb-4"><strong>Want to learn more about what we do with any information we collect?</strong> Review the Privacy Notice in full.</p>

                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">TABLE OF CONTENTS</h2>
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">1. WHAT INFORMATION DO WE COLLECT?</h2>

                        <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Personal information you disclose to us</h3>
                        ...
                        <ul className="list-disc pl-5 mb-4">
                            ...
                            <li>usernames</li>
                            <li>passwords (only if user accounts are enabled)</li>
                            <li>contact preferences</li>
                            <li>contact or authentication data</li>
                            <li>billing addresses (only if required for future paid services)</li>
                        </ul>
                        ...
                        <ul className="list-disc pl-5 mb-4">
                            <li>basic student-related information such as college name or accommodation preferences (excluding academic records, identification documents, or children’s data)</li>
                            <li>front gate pictures of mess</li>
                        </ul>

                        <p className="mb-2 font-semibold">Social Media Login Data.</p>
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Information automatically collected</h3>
                        ...
                        <ul className="list-disc pl-5 mb-4">
                            <li className="mb-2"><strong>Log and Usage Data.</strong> Log and usage data is service-related, diagnostic, usage, and performance information our servers automatically collect when you access or use our Services and which we record in log files. Depending on how you interact with us, this log data may include your IP address, device information, browser type, and settings and information about your activity in the Services (such as the date/time stamps associated with your usage, pages and files viewed, searches, and other actions you take such as which features you use), device event information (such as system activity, error reports (sometimes called 'crash dumps'), and hardware settings).</li>
                            <li className="mb-2"><strong>Device Data.</strong> We collect device data such as information about your computer, phone, tablet, or other device you use to access the Services. Depending on the device used, this device data may include information such as your IP address (or proxy server), device and application identification numbers, location, browser type, hardware model, Internet service provider and/or mobile carrier, operating system, and system configuration information.</li>
                            <li className="mb-2"><strong>Location Data.</strong> We collect location data such as information about your device's location, which can be either precise or imprecise. How much information we collect depends on the type and settings of the device you use to access the Services. For example, we may use GPS and other technologies to collect geolocation data that tells us your current location (based on your IP address). You can opt out of allowing us to collect this information either by refusing access to the information or by disabling your Location setting on your device. However, if you choose to opt out, you may not be able to use certain aspects of the Services.</li>
                            <li className="mb-2"><strong>User-Contributed Images and Property Photographs.</strong> Digital images of accommodation facilities, including hostels and PG residences, provided by property owners or uploaded by users in reviews. These may include photographs of room interiors, building exteriors, and common areas.</li>
                        </ul>

                        <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Google API</h3>
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Information collected from other sources</h3>
                        <p className="mb-2 italic">In Short: We may collect limited data from public databases, marketing partners, social media platforms, and other outside sources.</p>
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">2. HOW DO WE PROCESS YOUR INFORMATION?</h2>
                        ...
                        <ul className="list-disc pl-5 mb-4">
                            ...
                            <li>To facilitate booking requests and coordinate communication between users and accommodation providers.</li>
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">3. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</h2>
                        <p className="mb-2 italic">In Short: We may share information in specific situations described in this section and/or with the following categories of third parties.</p>

                        <p className="mb-2 font-semibold">Vendors, Consultants, and Other Third-Party Service Providers.</p>
                        <p className="mb-4">We may share your data with third-party vendors, service providers, contractors, or agents ('third parties') who perform services for us or on our behalf and require access to such information to do that work.</p>
                        ...
                        <ul className="list-disc pl-5 mb-4">
                            ...
                            <li className="mb-2"><strong>When we use Google Maps Platform APIs.</strong> We may share your information with certain Google Maps Platform APIs (e.g. Google Maps API, Places API). Google Maps uses GPS, Wi-Fi, and cell towers to estimate your location. GPS is accurate to about 20 meters, while Wi-Fi and cell towers help improve accuracy when GPS signals are weak, like indoors. This data helps Google Maps provide directions, but it is not always perfectly precise. We obtain and store on your device ('cache') your location. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document.</li>
                            <li className="mb-2"><strong>Business Partners.</strong> We may share your information with our business partners to offer you certain products, services, or promotions.</li>
                        </ul>

                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">4. WHAT IS OUR STANCE ON THIRD-PARTY WEBSITES?</h2>
                        <p className="mb-2 italic">In Short: We are not responsible for the safety of any information that you share with third parties that we may link to or who advertise on our Services, but are not affiliated with, our Services.</p>
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</h2>
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Google Analytics</h3>
                        <p className="mb-4">We may share your information with Google Analytics to track and analyse the use of the Services. The Google Analytics Advertising Features that we may use include: Remarketing with Google Analytics, Google Display Network Impressions Reporting and Google Analytics Demographics and Interests Reporting. To opt out of being tracked by Google Analytics across the Services, visit <a href="https://tools.google.com/dlpage/gaoptout" className="text-blue-600 hover:underline">https://tools.google.com/dlpage/gaoptout</a>. You can opt out of Google Analytics Advertising Features through Ads Settings and Ad Settings for mobile apps. Other opt out means include <a href="http://optout.networkadvertising.org/" className="text-blue-600 hover:underline">http://optout.networkadvertising.org/</a> and <a href="http://www.networkadvertising.org/mobile-choice" className="text-blue-600 hover:underline">http://www.networkadvertising.org/mobile-choice</a>. For more information on the privacy practices of Google, please visit the Google Privacy & Terms page.</p>

                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</h2>
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">7. HOW LONG DO WE KEEP YOUR INFORMATION?</h2>
                        ...
                        <p className="mb-4">We will only keep your personal information for as long as it is necessary for the purposes set out in this Privacy Notice, unless a longer retention period is required or permitted by law (such as tax, accounting, or other legal requirements). No purpose in this notice will require us keeping your personal information for longer than seven (7) months past the termination of the user's account.</p>
                        <p className="mb-4">When we have no ongoing legitimate business need to process your personal information, we will either delete or anonymise such information, or, if this is not possible (for example, because your personal information has been stored in backup archives), then we will securely store your personal information and isolate it from any further processing until deletion is possible.</p>

                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">8. HOW DO WE KEEP YOUR INFORMATION SAFE?</h2>
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">9. WHAT ARE YOUR PRIVACY RIGHTS?</h2>
                        ...
                        <h3 className="text-xl font-semibold text-gray-700 mt-6 mb-2">Account Information</h3>
                        ...
                        <ul className="list-disc pl-5 mb-4">
                            ...
                            <li>Email our Data Grievance Officer at messkhojooperator@gmail.com</li>
                        </ul>
                        ...
                        <p className="mb-4">If you have questions or comments about your privacy rights, you may email us at messkhojooperator@gmail.com.</p>

                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">10. CONTROLS FOR DO-NOT-TRACK FEATURES</h2>
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">11. DO WE MAKE UPDATES TO THIS NOTICE?</h2>
                        ...
                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</h2>
                        <p className="mb-4">If you have questions or comments about this notice, you may email us at messkhojooperator@gmail.com or contact us by post at:</p>
                        <p className="mb-4 bg-gray-50 p-4 rounded-lg">
                            <strong>MessKhojo</strong><br />
                            Jayadebkasapa<br />
                            Bardhanpur<br />
                            Balasore, Odisha 756021<br />
                            India
                        </p>

                        <h2 className="text-2xl font-bold text-gray-800 mt-8 mb-4">13. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</h2>
